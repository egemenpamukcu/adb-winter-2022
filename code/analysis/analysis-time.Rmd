...
fsi_climate.model <- plm(state_legit ~ air_quality + climate_change + hdi_value + gdp, data = df, index = c("iso", "year"), model = "within", effect = "twoways")
>>>>>>> f745eb98ca5b6ceadaad9b9767b6f3359a3cb13b
